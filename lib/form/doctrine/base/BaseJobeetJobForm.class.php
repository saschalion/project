...
abstract class BaseJobeetJobForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'year_graduation'                    => new sfWidgetFormDate(),
    ...
    $this->setValidators(array(
      ...
      'name_foreign_language'              => new sfValidatorString(array('max_length' => 10, 'required' => false)),
      'degree_knowledge_foreign_languages' => new sfValidatorString(array('max_length' => 10, 'required' => false)),
      ...
      'year_graduation'                    => new sfValidatorDate(array('required' => false)),
