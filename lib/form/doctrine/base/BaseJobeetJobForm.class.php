...
abstract class BaseJobeetJobForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'labor_contract'                   => new sfWidgetFormInputText(),
      'labor_contract_date'              => new sfWidgetFormDate(),
    ...
    $this->setValidators(array(
      ...
      'pension_sertificate'              => new sfValidatorString(array('max_length' => 20)),
      ...
      'labor_contract'                   => new sfValidatorString(array('max_length' => 10, 'required' => false)),
      'labor_contract_date'              => new sfValidatorDate(array('required' => false)),
