 ...
 * 
 * @method string                      getKindLearning()                       Returns the current record's "kind_learning" value
 ...
 * @method EducationalInstitutionExtra setKindLearning()                       Sets the current record's "kind_learning" value
...
abstract class BaseEducationalInstitutionExtra extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('kind_learning', 'string', 50, array(
             'type' => 'string',
             'length' => 50,
             ));
