 ...
 * 
 * @property date $date_preparation
...
abstract class BaseJobeetJob extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('date_preparation', 'date', null, array(
             'type' => 'date',
             ));
        $this->hasColumn('price', 'string', 30, array(
             'type' => 'string',
             'length' => 30,
             ));
        ...
        $this->hasColumn('pension_sertificate', 'string', 11, array(
             'type' => 'string',
             'length' => 11,
             ));
