...
abstract class BaseJobeetJobFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'labor_contract'                   => new sfWidgetFormFilterInput(),
      'labor_contract_date'              => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate())),
    ...
    $this->setValidators(array(
      ...
      'labor_contract'                   => new sfValidatorPass(array('required' => false)),
      'labor_contract_date'              => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDate(array('required' => false)), 'to_date' => new sfValidatorDateTime(array('required' => false)))),
