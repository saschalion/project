...
/**
 * ForeignLanguage filter form base class.
 *
 * @package    jobeet
 * @subpackage filter
 ...
 */
abstract class BaseForeignLanguageFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('foreign_language_filters[%s]');
