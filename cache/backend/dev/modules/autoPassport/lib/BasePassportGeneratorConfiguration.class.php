 ...
 */
abstract class BasePassportGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return '%%id%% - %%passport_number%% - %%issuance_passports%% - %%date_issue_passport%% - %%code_division%% - %%created_at%% - %%updated_at%%';
  }
  ...
  {
    return array(  0 => 'id',  1 => 'passport_number',  2 => 'issuance_passports',  3 => 'date_issue_passport',  4 => 'code_division',  5 => 'created_at',  6 => 'updated_at',);
  }
